...
- Control plane: `control_plane.enabled` derives component resources (`component_resource_prefix`), uses `fallback_resource` for unmapped files, and prefers derived resources via `resources_mode: prefer-derived`.
